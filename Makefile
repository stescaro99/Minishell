...
SRCS = src/env_utils.c src/exec_shell.c src/execve.c src/f_strjoin.c src/handle_quote.c \
		...
		src/set_line.c src/set_lst_new.c src/shell_utils.c src/shell.c src/shell2.c src/awk_utils.c
