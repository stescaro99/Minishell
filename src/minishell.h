...
void		handle_quote(char **tmp, int *i, char *line, t_echo **echo);
...
int			echo_shell(t_line **l, int ret, t_echo **echo);
void		handle_logic(t_line **line);
...
int			echo_no_string(t_line **line, t_echo **echo);
...
t_echo		*echo_lstnew(char *str);
t_echo		*echo_lst_clear(t_echo *lst);
